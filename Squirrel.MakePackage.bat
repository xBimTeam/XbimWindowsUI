...
@echo Releasifying
@"%userprofile%\.nuget\packages\squirrel.windows\1.9.2-cb003\tools\Squirrel.exe" --releasify Xbim.Xplorer.%version%.nupkg --releaseDir=..\XplorerReleases --no-msi --icon=XbimXplorer\xBIM.ico --setupIcon=XbimXplorer\xBIM.ico --framework-version=net47
